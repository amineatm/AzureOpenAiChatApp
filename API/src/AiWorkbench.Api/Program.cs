...
builder.Services.AddDbContext<AiWorkbenchDbContext>(options =>
    options.UseSqlServer(
        connectionString,
        sqlOptions => sqlOptions.MigrationsAssembly("AiWorkbench.Infrastructure")));
...
builder.Services.AddApiHubServices();
